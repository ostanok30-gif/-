...
def transcribe_audio_bytes(audio_bytes):
    """Расшифровка аудио из байтов"""
    try:
        # Конвертируем
        wav_data = ogg_to_wav_bytes(audio_bytes)
        if wav_data is None:
            return None
...
def handle_voice(message):
    ...
    try:
        ...
        # Расшифровываем напрямую из байтов
